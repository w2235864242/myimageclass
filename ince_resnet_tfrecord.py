...
if __name__ == '__main__':
    ...
    # print img.shape
    # print label.shape
    creat_tfrecord('/home/ning/new/programs/myprogram/myimageclass/test_data/train/')
    #creat_tfrecord('/home/ning/new/programs/myprogram/myimageclass/test_data/test/')
